...
public class Utilities {
    ...
    //to each other, by removing an occurrenceof the character
    //"ABBCDEEF" -> "ABCDEF"
    //"ABCBDEEF" -> "ABCBDEF" (the two Bs arent next to each other, so they
    //aren't removed
    public String removePairs(String source){
        ...
        //add the final char, which is always safe
